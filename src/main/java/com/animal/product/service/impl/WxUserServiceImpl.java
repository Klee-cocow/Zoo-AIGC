...
import com.animal.product.model.dto.WXListDTO;
import com.animal.product.model.entity.WxUserInfo;
    ...
    public String responseMsg(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if ("event".equals(msgType)) { // 如果是事件推送
                ...
                redisTemplate.opsForValue().set(ticket, String.valueOf(zooUsers.getId()),10,TimeUnit.SECONDS);
